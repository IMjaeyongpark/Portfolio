      ...
      <div className="page-container relative flex min-h-[78vh] flex-col items-center justify-center pt-32 pb-20 text-center sm:pt-40 sm:pb-24">
        ...
        <Reveal delay={360}>
          <div className="mt-9 flex flex-wrap justify-center gap-3">
            {portfolio.github && <a href={portfolio.github} target="_blank" rel="noreferrer" className="focus-ring group inline-flex items-center gap-2 rounded-full border border-white/20 px-5 py-3 text-sm font-semibold text-white/75 transition-colors hover:border-white/40 hover:text-white"><Icon name="github" size={17} /> GitHub <Icon name="external" size={14} className="transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" /></a>}
